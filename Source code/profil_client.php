<?php
 ...
 $data = $connection->query("SELECT Nume, Prenume, CNP, Sex FROM clienti WHERE User='$user'");
  ...
  <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          ...
          <?php
              if(isset($_SESSION['response_edc'])){
                  $sesiune=$_SESSION['response_edc'];
                  echo("<p style='color: red;'>$sesiune</p>");
                  $_SESSION['response_edc']=null;
              }
           ?>
        </h4>
      </div>
      <div id="collapse2" class="panel-collapse collapse">
        ...
        <div class="container">
                <form method="POST" action="editare_date_client.php">
      ...
      <div class="panel-heading">
        <h4 class="panel-title">
          ...
          <?php
              if(isset($_SESSION['response_eac'])){
                  $sesiune=$_SESSION['response_eac'];
                  echo("<p>$sesiune</p>");
                  $_SESSION['response_eac']=null;
              }
           ?>
        </h4>
      </div>
      <div id="collapse3" class="panel-collapse collapse">
        ...
        <div class="container">
                <form method="POST" action="editare_adresa_client.php">
